  ...
  return (
    <div className="fixed-bottom" style={{ height }}>
      ...
      >
        <div
          style={{ fontSize: 12 }}
          className="flex position-relative flex-col grow"
          ref={panelRef}
        >
          <div className="z-2 flex">
            <div
              className="flex w-full items-center position-relative border-top border-dark bg-light"
              ref={terminalMenu}
              style={{ height: 35 }}
            ...
            >
              ...
              {shortname && (
                <div
                  className="ps-4 remix_ui_terminal_toggleTerminal"
                  onClick={() => {
                    setDisplay('comment');
                  }}
                >
          ...
          >
            <div
              className={`position-relative flex-col-reverse h-full ${
            ...
            {/* {shortname && (
              <div className={`p-4 ${display === 'comment' ? '' : 'hidden'}`}>
                <DiscussionEmbed
                  shortname={shortname}
                  config={{
                    url: window.origin,
