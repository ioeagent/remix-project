...
import { Accordion, Button } from '@remix-ui/helper';
import './app.css'
  ...
  return (
    <IntlProvider locale={locale.code} messages={locale.messages}>
      <main id="vyper-plugin">
        <section>
          <div className="px-4 pt-4 mb-4 w-full">
                    ...
                    <div className="flex flex-row justify-around mb-1 mt-2">
                      <div className={`form-control custom-radio ${state.environment === 'remote' ? 'flex' : 'flex cursor-status'} bg-body`}>
                        <input
                          ...
                          className={`form-check-input ${state.environment === 'remote' ? 'flex me-1' : 'flex me-1 cursor-status'}`}
                        />
                        <label
          ...
          <span className="w-full px-4 mt-4 mb-1 small text-warning">
          Specify the{' '}
          ...
          <div className="px-4 w-full mb-4 mt-1" id="compile-btn">
          ...
          <article id="result" className="px-4 p-2 w-full border-top mt-2 vyper-errorBlobs">
