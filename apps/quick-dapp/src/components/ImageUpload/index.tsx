...
const ImageUpload = () => {
  ...
  return (
    <div className="w-1/4 pe-0 my-2 flex justify-center items-center">
        ...
        <div className="bg-light" style={{ height: 158.5, width: 158.5 }}>
          <div style={{ padding: 15 }}>
            ...
            <label htmlFor="upload-button" className='text-center block'>
              ...
              >
                <div className='mt-6 btn btn-primary btn-sm' style={{ height: 32, width: 100, lineHeight: '22px' }}>Select Logo</div>
              </CustomTooltip>
            </label>
          </div>
        </div>
