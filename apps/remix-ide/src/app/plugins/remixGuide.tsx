  ...
  updateComponent(state: any) {
    return (
      <div className='flex'>
        ...
        >
          <div className="self-center pb-6" role="document">
            <div
              tabIndex={-1}
              className={'modal-content remixModalContent mb-6'}
            >
              <div className="break-words remixModalBody flex flex-col p-4 justify-between" data-id={`EnterModalDialogModalBody-react`}>
