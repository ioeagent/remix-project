...
import { Popover, getPathIcon } from '@remix-ui/helper';
...
export const FlatTree = (props: FlatTreeProps) => {
        ...
        <div data-id={`treeViewDivtreeViewItem${file.path}`} className={`flex flex-row items-center`}>
          ...
          {focusEdit && file.path && focusEdit.element === file.path ?
            ...
            <><div
              ...
              onDragEnd={onDragEnd}
              className={`ms-1 ps-2 whitespace-nowrap remixui_leaf ${getFileStateClasses(file)}`}
  ...
  return (<>
    <div ref={containerRef} className='h-full ps-1 mt-1'>
      <FlatTreeDrop
        ...
        >
          { showMouseOverTarget && mouseOverTarget && !isDragging &&
            <Popover id='popover-basic'
              ...
              <Popover.Body className='text-wrap p-1 px-2 bg-body w-full'>
