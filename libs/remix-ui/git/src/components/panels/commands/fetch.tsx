  ...
  return (
    <>
      <div className="btn-group w-full" role="group">
        ...
        })} className="btn btn-secondary me-1 w-1/2"><div>Fetch {context.upstream && context.upstream.name}</div></GitUIButton>
        ...
        })} className="btn btn-secondary w-1/2 long-and-truncated">Fetch {context.currentBranch.name}</GitUIButton>
      </div>
    </>)
}
