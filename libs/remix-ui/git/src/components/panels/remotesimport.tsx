...
export const RemotesImport = () => {
  ...
  return (
    <>
      ...
      {repo && remoteName ?
        <button data-id='remote-panel-addremote' className='inline-flex items-center px-4 py-2 bg-primary text-white rounded-md hover:bg-primary/90 transition-colors mt-1 w-full' onClick={async () => {
          await addRemote()
