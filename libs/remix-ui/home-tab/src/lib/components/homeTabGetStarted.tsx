...
function HomeTabGetStarted({ plugin }: HomeTabGetStartedProps) {
  ...
  return (
    <div className="ps-2" id="hTGetStartedSection">
      <label className="pt-4" style={{ fontSize: '1.2rem' }}>
              ...
              {workspaceTemplates.map((template, index) => (
                ...
                >
                  <button
                    key={index}
                    className={index === 0 ?
                      'btn btn-primary border p-2 whitespace-nowrap me-4 mb-4' :
                      index === workspaceTemplates.length - 1 ?
                        'btn border p-2 whitespace-nowrap me-2 mb-4' :
                        'btn border p-2 whitespace-nowrap me-4 mb-4'
                    }
                    onClick={async (e) => {
