        ...
        <div className="container-fluid">
          <div className="row">
            <div className="d-flex w-100 m-3 justify-content-end">
              ...
              <button data-id="landingPageImportFromTemplate" className="btn btn-primary btn-md me-2" onClick={openSkillsSelection}><i className="fa-solid fa-plus me-1"></i><FormattedMessage id="home.loadSkills" /></button>
            </div>
