...
export const PromptArea: React.FC<PromptAreaProps> = ({
  ...
  return (
    <>
      <div
        className="prompt-area flex flex-col mx-2 p-2 rounded-3 border border-text bg-light"
        style={{ backgroundColor: themeTracker && themeTracker?.name.toLowerCase() === 'light' ? '#d9dee8' : '#2a2c3f' }}
      >
        <div className="flex justify-between items-center mb-4 border border-end-0 border-start-0 border-top-0 border-bottom pb-1">
          <div className="flex">
            <button
            ...
            {selectedModel?.provider === 'ollama' && ollamaModels.length > 0 && (
              <button
                ...
                className="btn btn-text btn-sm small font-weight-light text-secondary mt-2 self-end border border-text rounded ms-2"
          ...
          <span
            className="btn btn-sm disabled small rounded-3 self-center font-light"
        ...
        <div className="ai-chat-input flex flex-col">
          <div
            className="flex flex-col rounded-3 p-1"
            style={{
          ...
          >
            <button className={`btn font-light rounded-4 whitespace-nowrap ${themeTracker && themeTracker.name.toLowerCase() === 'light' ? 'btn-light text-light-emphasis' : 'btn-remix-dark'}`}
